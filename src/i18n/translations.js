...
export const translations = {
  pt: {
    ...
    about: {
      ...
      paragraphs: [
        'Sou um profissional apaixonado por tecnologia, desenvolvimento de software e soluções voltadas para CRM. Atualmente curso Ciência da Computação e atuo com Salesforce Marketing Cloud, participando da criação, automação e otimização de campanhas digitais que conectam empresas aos seus clientes.',
        'No meu dia a dia trabalho apoiando operações de CRM, criando segmentações utilizando SQL, desenvolvendo e ajustando templates de e-mail com HTML e CSS, organizando bases de dados, acompanhando métricas de campanhas e participando da construção de jornadas de relacionamento através do Journey Builder e automações no Automation Studio. Essa experiência me permite unir tecnologia, estratégia e análise de dados para entregar campanhas mais eficientes e personalizadas.',
        'Minha trajetória profissional começou nas áreas de atendimento e vendas, experiência que fortaleceu habilidades como comunicação, resolução de problemas, visão de negócio e foco na experiência do cliente. Hoje aplico esse conhecimento na tecnologia, entendendo que um bom desenvolvedor também precisa compreender as necessidades do usuário e os objetivos da empresa.',
        'Além da experiência com Salesforce Marketing Cloud, continuo evoluindo meus conhecimentos em React, JavaScript, Python, Node.js, SQL, Power BI e desenvolvimento web, buscando criar aplicações modernas, integrações e automações que simplifiquem processos e gerem valor para os negócios.',
        'Meu objetivo é construir uma carreira sólida nas áreas de CRM, Salesforce e desenvolvimento de software, contribuindo para projetos escaláveis, soluções inteligentes e experiências digitais que realmente façam a diferença.',
      ],
      highlights: [
  ...
  en: {
    ...
    about: {
      ...
      paragraphs: [
        "I'm a professional passionate about technology, software development, and CRM-focused solutions. I'm currently pursuing a degree in Computer Science and working with Salesforce Marketing Cloud, where I help create, automate, and optimize digital campaigns that connect companies with their customers.",
        'On a day-to-day basis, I support CRM operations, build audience segmentations using SQL, develop and fine-tune email templates with HTML and CSS, organize databases, track campaign metrics, and help build customer relationship journeys through Journey Builder and automations in Automation Studio. This experience lets me combine technology, strategy, and data analysis to deliver more efficient, personalized campaigns.',
        'My professional journey began in customer service and sales, an experience that strengthened skills such as communication, problem-solving, business acumen, and a focus on customer experience. Today I apply that knowledge in technology, understanding that a good developer also needs to grasp user needs and business goals.',
        'Beyond my experience with Salesforce Marketing Cloud, I keep growing my skills in React, JavaScript, Python, Node.js, SQL, Power BI, and web development, aiming to build modern applications, integrations, and automations that simplify processes and generate business value.',
        'My goal is to build a solid career in CRM, Salesforce, and software development, contributing to scalable projects, smart solutions, and digital experiences that truly make a difference.',
      ],
      highlights: [
  ...
  es: {
    ...
    about: {
      ...
      paragraphs: [
        'Soy un profesional apasionado por la tecnología, el desarrollo de software y las soluciones orientadas a CRM. Actualmente estudio Ciencias de la Computación y trabajo con Salesforce Marketing Cloud, participando en la creación, automatización y optimización de campañas digitales que conectan a las empresas con sus clientes.',
        'En mi día a día trabajo apoyando operaciones de CRM, creando segmentaciones con SQL, desarrollando y ajustando plantillas de correo electrónico con HTML y CSS, organizando bases de datos, dando seguimiento a las métricas de las campañas y participando en la construcción de recorridos de relacionamiento a través de Journey Builder y automatizaciones en Automation Studio. Esta experiencia me permite combinar tecnología, estrategia y análisis de datos para entregar campañas más eficientes y personalizadas.',
        'Mi trayectoria profesional comenzó en las áreas de atención al cliente y ventas, experiencia que fortaleció habilidades como la comunicación, la resolución de problemas, la visión de negocio y el enfoque en la experiencia del cliente. Hoy aplico ese conocimiento en la tecnología, entendiendo que un buen desarrollador también necesita comprender las necesidades del usuario y los objetivos de la empresa.',
        'Además de la experiencia con Salesforce Marketing Cloud, sigo ampliando mis conocimientos en React, JavaScript, Python, Node.js, SQL, Power BI y desarrollo web, buscando crear aplicaciones modernas, integraciones y automatizaciones que simplifiquen procesos y generen valor para los negocios.',
        'Mi objetivo es construir una carrera sólida en las áreas de CRM, Salesforce y desarrollo de software, contribuyendo a proyectos escalables, soluciones inteligentes y experiencias digitales que realmente marquen la diferencia.',
      ],
      highlights: [
        { icon: 'location', label: 'Brasil' },
