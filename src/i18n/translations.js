...
export const translations = {
  pt: {
    ...
    hero: {
      ...
      role: 'Desenvolvedor Full-Stack & Especialista em Integrações',
      tagline:
        'Construo aplicações web e integrações robustas que conectam sistemas, simplificam processos e escalam junto com o seu negócio.',
    ...
    services: {
      ...
      heading: 'Soluções sob medida, do front-end à integração',
      subheading:
    ...
    about: {
      ...
      highlights: [
        ...
        { icon: 'experience', label: '+X anos de experiência' },
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'Projeto de estudo focado em acessibilidade e responsividade: HTML semântico, contraste adequado e layout fluido para qualquer tamanho de tela.',
        },
      ],
    },
    cta: {
      ...
      subheading:
        'Vamos conversar sobre como transformar sua ideia em uma solução funcionando em produção.',
  ...
  en: {
    ...
    hero: {
      kicker: "Hi, I'm",
      name: 'Vitor Martimiani',
      role: 'Full-Stack Developer & Integration Specialist',
      tagline:
        'I build web applications and robust integrations that connect systems, simplify processes and scale with your business.',
    ...
    services: {
      ...
      heading: 'Tailored solutions, from front-end to integration',
      subheading:
    ...
    about: {
      ...
      highlights: [
        ...
        { icon: 'experience', label: '+X years of experience' },
        { icon: 'focus', label: 'Salesforce Marketing Cloud' },
      ],
    },
    certifications: {
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'A study project focused on accessibility and responsiveness: semantic HTML, proper contrast, and a fluid layout for any screen size.',
        },
      ],
    },
    cta: {
      heading: 'Have a project in mind?',
      subheading: "Let's talk about turning your idea into a solution running in production.",
  ...
  es: {
    ...
    hero: {
      kicker: 'Hola, soy',
      name: 'Vitor Martimiani',
      role: 'Desarrollador Full-Stack y Especialista en Integraciones',
      tagline:
        'Construyo aplicaciones web e integraciones robustas que conectan sistemas, simplifican procesos y escalan junto a tu negocio.',
    ...
    services: {
      ...
      heading: 'Soluciones a medida, del front-end a la integración',
      subheading:
    ...
    about: {
      ...
      highlights: [
        { icon: 'location', label: 'Brasil' },
        { icon: 'experience', label: '+X años de experiencia' },
        { icon: 'focus', label: 'Salesforce Marketing Cloud' },
      ],
    },
    certifications: {
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'Proyecto de estudio enfocado en accesibilidad y responsividad: HTML semántico, contraste adecuado y un diseño fluido para cualquier tamaño de pantalla.',
        },
      ],
    },
    cta: {
      heading: '¿Tienes un proyecto en mente?',
      subheading: 'Hablemos sobre cómo convertir tu idea en una solución funcionando en producción.',
